...
extern uint8_t get_chassis_power_max(void);
extern uint16_t get_spinner_offsets(void);
extern uint8_t get_chassis_speed_ratio(void);
extern uint16_t get_spinner_speed(void);
#endif

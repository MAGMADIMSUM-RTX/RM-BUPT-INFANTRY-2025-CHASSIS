 ...
 * @LastEditTime: 2025-03-27 00:10:35
...
void ui_lineangle_update(uint16_t ecd)
{
    ...
    ui_g_Ungroup_Lineangle->start_x = (int)(960 + 450 * arm_cos_f32(angle_rad));
    ui_g_Ungroup_Lineangle->start_y = (int)(540 + 450 * arm_sin_f32(angle_rad));
    ui_g_Ungroup_Lineangle->end_x = (int)(960 + 480 * arm_cos_f32(angle_rad));
    ui_g_Ungroup_Lineangle->end_y = (int)(540 + 480 * arm_sin_f32(angle_rad));
}
